...
export default function Pomodoro({ children }: Props) {
    return (
        <div className='bg-red-900 h-[250px] flex w-[250px] items-center justify-center rounded-full mt-5 mb-10 shadow-2xl shadow-black/80 relative overflow-hidden select-none'>
